...
(((
<msg type=note>Если плагин инициализировался правильно, то после загрузки контрола при наведении курсора на границу между столбцами курсор меняет свой внешний вид и появляется возможность изменять ширину столбцов.

Если настройка включена, однако изменение ширины столбцов не доступно, то рекомендуется проверить консоль разработчика, возможно туда вывелись ошибки.</msg>
)))
