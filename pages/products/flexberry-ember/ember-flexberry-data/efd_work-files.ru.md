...
```javascript
{
  "entityTypeName": "", // Assembly-qualified имя типа объекта данных.
  "entityPrimaryKey": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // Первичный ключ объекта данных.
  "entityPropertyName": "File", // Наименование файлового свойства в объекте данных.
  "fileName": "image.png", // Наименование файла.
  "fileSize": 12345, // Размер файла в байтах.
  "fileMimeType": "image/png" // MIME-тип, соответствующий файлу.
}
