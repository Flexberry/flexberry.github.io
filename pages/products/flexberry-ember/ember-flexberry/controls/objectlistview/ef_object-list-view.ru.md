...
Основное предназначение __flexberry-objectlistview__ - просмотр списка доступных объектов с возможностью их последующего открытия и редактирования (в контрол встроен пейджинг, позволяющий просматривать данные порционно).
...
{% include note.html content="Рекомендуется реализовать уведомление-вопрос для пользователя об удалении объектов." %}
