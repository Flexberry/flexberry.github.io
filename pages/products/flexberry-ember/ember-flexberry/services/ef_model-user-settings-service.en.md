...
Примечание: если компонент будет в шаблоне роута, не являющешлся наследником `list-form` и `edit-form` `ember-flexberry`, то настройки не будут загружены, и соответственно никакого эффекта не будет.
