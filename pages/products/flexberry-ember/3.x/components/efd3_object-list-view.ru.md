...
_Пользовательские ограничения. Возможности сервиса adv-limit. Настройки для пользовательских ограничений в конфигурационном файле._
...
В состав контрола [Flexberry Objectlistview](https://flexberry.github.io/ru/efd3_listform.html) входит панель управления, которую можно настраивать и добавлять пользовательские кнопки.
