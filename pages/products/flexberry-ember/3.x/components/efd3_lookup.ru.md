...
* `title` - заголовок модального окна для выбора значения (рекомендуется задавать [локализованное значение]()).
...
* `settings` - [настройки](https://semantic-ui.com/modules/modal.html#/settings), которые передаются компоненту [Semantic UI Modal](https://semantic-ui.com/modules/modal.html), на базе которого реализовано модальное окно.
