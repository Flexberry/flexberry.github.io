...
Метод `byId` построителя запросов принимает в качстве параметра строку или число - первичный ключ объекта (значение типа GUID необходимо передавать в нижнем регистре).
