...
`showPrototypeButtonInRow` - флаг, определяющий отображать ли кнопку создания но основе в строке.
`showPrototypeMenuItemInRow` - флаг, определяющий отображать ли кнопку создания но основе в меню строки.
