...
`Ember Data` — это библиотека для надежного управления данными модели. Она независима от базового механизма сохранения, поэтому работает как с API-интерфейсами JSON через HTTP, так и с потоковой передачей WebSockets или локальным хранилищем IndexedDB.
...
### Где Ember Data обращается к Ember Inflector
