...
Доступны темы [`blue-sky`](ef_supported_themes.html#bluesky-theme), [`orange`](ef_supported_themes.html#orange-theme-временно-не-поддерживается).
...
В данном пакете доступны темы [`blue-sky`](ef_supported_themes.html#bluesky-theme), [`ghost`](ef_supported_themes.html#ghost).
...
![screenshoot](/images/pages/img_themes/screenshots/exam_default_fields.jpg)
