...
* Для статей на русском языке добавляется `.ru`, для статей на английском - `.en`. Соответственно, **при дополнении статей следует дополнять информацию для обеих локалей**.
