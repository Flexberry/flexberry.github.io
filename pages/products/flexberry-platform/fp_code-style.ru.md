...
В .NET Open Source-проектах платформы Flexberry набор соглашений реализуется за счёт механизма "Наборов правил", который [присутсвует](https://msdn.microsoft.com/ru-ru/library/dd465186.aspx) в Microsoft Visual Studio - придерживайтесь подсказок IDE, чтобы код будет хорошим и согласованным.
...
Файл с правилами которые использутся в проектах платформы Flexberry можно взять [по ссылке](https://github.com/Flexberry/NewPlatform.Flexberry.ORM/blob/develop/Flexberry.ruleset).
...
2. В корне проекта, создать и настроить файл `.eslintrc.js` пример файла можно посмотреть [по ссылке](https://github.com/Flexberry/ember-flexberry/blob/feature-ember-update/.eslintrc.js).
3. В корне проекта, создать файл `.eslintignore` - в него нужно добавить файлы и дериктории которые не должны проверятся JSLint-ом. Пример файла можно посмотреть [по ссылке](https://github.com/Flexberry/ember-flexberry/blob/feature-ember-update/.eslintignore).
...
2. В корне проекта, создать и настроить файл `.jshintrc` пример файла можно посмотреть [по ссылке](https://github.com/Flexberry/ember-flexberry/blob/develop/.jshintrc).
