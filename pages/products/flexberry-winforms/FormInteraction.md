...
#** Если параметр `propertyname` не пустой, то происходит проверка на наличие такого свойства типа `[DataObject](dataobject.html)` у объекта, переданного на редактирование.
