...
#** Если параметр `propertyname` не пустой, то происходит проверка на наличие такого свойства типа `[DataObject](fo_dataobject.html)` у объекта, переданного на редактирование.
