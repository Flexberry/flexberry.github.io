...
| ![](/images/pages/products/flexberry-winforms/forms/editformoperations.jpg)  Позволяет указать, какие операции доступны на этой форме (соответственно, какие кнопки появляются на панели управления):
