...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterExList1.PNG)
...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterExList2.PNG)
...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterExList3.PNG)
...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterExList4.PNG)
...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterSettingsEx0.PNG)
...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterSettingsEx1.PNG)
...
# На форме: ![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterSettingsEx2.PNG)
#* Введем `Наименование` настройки
#* Выберем сборку из выпадающего списка
#* Выберем тип `Кредит`
#* Выберем представление `КредитL`
#* ![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterSettingsEx3.PNG)
...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterSettingsEx4.PNG)
...
![](/images/pages/products/flexberry-winforms/subsystems/limits/FilterSettingsEx5.PNG)
