...
2. При нажатии на кнопку "Открыть" поднимается форма редактирования, соответствующая типу объекта в [`GroupEdit`](fw_group-edit.html). При поднятии формы данные, введённые в [`GroupEdit`](fw_group-edit.html), отражаются на форме.
