---
title: Создание вычислимого поля
sidebar: flexberry-orm_sidebar
keywords: Flexberry ORM, типы данных, представление
summary: Пример создания вычислимого поля с помощью DataServiceExpression
toc: true
permalink: ru/fo_creating-computable-field.html
lang: ru
---
