...
Supported multiple [standard data](fo_standard-data-services.html), and, if necessary, users can be [developed](fo_implement-custom-ds.html) new to meet your specific requirements (for example, inheriting class `ICSSoft.STORMNET.Business.`[`SQLDataService`](fo_sql-data-service.html)).
