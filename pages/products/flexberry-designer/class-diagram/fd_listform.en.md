---
title: Сlasses with stereotype listform
sidebar: flexberry-winforms_sidebar
keywords: Flexberry Designer, списковая форма, генерация, listform
...
Если указано, то считается, что данный список иерархический. Соответственно, либо генерируется зависимая форма с контролом [ObjectHierarchicalView](fw_object-hierarchical-view-on-editform.html), либо используется универсальная зависимая форма иерархического списка `UniWinListHierarchical`.
