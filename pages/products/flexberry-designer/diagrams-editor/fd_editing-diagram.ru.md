...
**Копировать выделенные объекты** | Выделенные на диаграмме элементы копируются в буфер обмена *Windows*. Скопированные элементы можно вставить как в [Flexberry Designer](fd_landing_page.html) на другую однотипную диаграмму, так и в какое-либо другое приложение (например, текстовый или графический редактор) в виде *Windows metafile (WMF)*.
