...
Подробнее о модулях и их подключении можно посмотреть в [статье Модули расширения функциональности](fd_case-plugins.html).
...
* Перейти на форму `История изменений стадии`
    *Выбрать пункт меню Стадии `HistoryPlugin - История изменения стадии`
    * Открылась форма `История изменений стадии&raquo`
