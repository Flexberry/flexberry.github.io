...
| OpenEditorInModalWindow  | Отображать форму редактирования (при создании\редактировании\просмотре объекта) в модальной форме (thickbox). Работает только если `OpenEditorInNewWindow == true`; Кастомный заголовок модальному окну можно задать через свойство WOLV-a EditorInModalWindowCaption |
