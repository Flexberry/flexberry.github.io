...
protected void WebObjectListView1_ObjectDeleting(WebObjectListView sender, WolvObjectDeletingEventArgs args)
{
    ...
    {   // Try to remove (further processing occurs in the Business server, Adress.cs).
        ...
        ICSSoft.STORMNET.Business.DataServiceProvider.DataService.UpdateObject(args.DataObj); // DataServiceProvider is deprecated; inject IDataService instead
    }
    ...
    if (Page.IsPostBack)
    {
        ...
        if (!String.IsNullOrEmpty(targetID))
        {
            ...
            if (targetID.Equals("confirmDeletingOkBtn"))
            {
                ...
                DataServiceProvider.DataService.UpdateObjects(ref deletingAdreses); // DataServiceProvider is deprecated; inject IDataService instead
            }
        }
    }
