...
(((<msg type=important>При работе с сервисом используется [ServiceSecurityProvider](fa_service-security-provider.html).</msg>)))
<br />
