...
''__Примечание__: реализация интерфейсов соответствует представленной схеме, однако в соответствии с планом на [первый этап](devprocess_audit-stages.html) тестирование прошла только часть функционала''
