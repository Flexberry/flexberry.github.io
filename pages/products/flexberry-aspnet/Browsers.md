...
# Браузеры
На данный момент технология Flexberry ASP.NET поддерживает следующие браузеры:
...
Приложения на базе Flexberry ASP.NET работают практически на всех платформах, но не на всех браузерах.
