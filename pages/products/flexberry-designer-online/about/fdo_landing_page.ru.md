...
1. Открыть портал [flexberry.net](https://flexberry.net/).
...
Для __командной разработки__ рекомендуется использовать [Liquibase](https://flexberry.github.io/ru/gbt_liquibase.html) - библиотеку с открытым исходным кодом для отслеживания, управления и применения изменений схемы базы данных.
