...
Все стандартные компоненты элементы системы дложны быть описаны. Должно быть теоретическое описание, практические применение и лучшие примеры реализации.
...
3.2 [Расположнеие элементов на десктопе](uiuxg_desktop_layout.ru.md)

3.3 [Расположнеие элементов на мобильных устройствах](uiuxg_mobile_layout.ru.md)
