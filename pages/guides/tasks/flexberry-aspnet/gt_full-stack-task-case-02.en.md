...
lang: en 
autotranslated: true 
hash: 064075c9ce452b1ac62c98f4be97590141b5098c995e8e269c098b334afef66c 
--- 

## Job 

In the framework of the practical part of the course you will have developed end-to-end example: the application "Application applicants" (module IP for universities). 
...
2. Number when creating a new application must be placed automatically. Format: reduction of type zajavlenie ("IN", "SPO" or "ASP"), a dash, the sequence number of the statement. 
