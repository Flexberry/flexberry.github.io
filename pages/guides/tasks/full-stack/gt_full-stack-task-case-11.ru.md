...
У каждой группы есть целочисленное свойство «стоимость годового посещения», необходимо выводить на страницу с данными студента суммарную плату за всё его обучение.
