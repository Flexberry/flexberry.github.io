...
Требуется реализовать алгоритм вычисления полного наименования территории. Для этого должна появиться связь «родитель». Для вычисления полного наименования требуется «пройти» по всем родителям и «собрать» полное наименование.
...
1. Логику ввода полного наименования и использование библиотеки из предыдущего пункта для выдачи информации о всей иерархии территорий (поле для ввода значения, кнопка, блок с отображением результатов).
2. Логику получения полного наименование для указанной информации об иерархии территорий (поля для ввода значений, кнопка, блок с отображением результатов).
