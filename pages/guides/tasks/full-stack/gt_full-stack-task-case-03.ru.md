...
В рамках выполнения практической части курса вами будет разработан сквозной пример: приложение «Аренда земельных участков» (модуль ИС для проектного управления).
