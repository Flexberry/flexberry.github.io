...
Будем использовать это свойство на форме редактирования **Заказа** для отображения выбранного значения лукапа (свойство `displayAttributeName`), соответсвующего полю **Менеджер**:
