...
3. [ember-cli](https://github.com/ember-cli/ember-cli) - версия 3.1.4. Информацию об используемых версиях можно найти на странице [соответствующего аддона](https://github.com/Flexberry/ember-flexberry).
