...
Для возможности добавления **Накладных** нам также предварительно потребуется реализовать логику автоматического вычисления значений некоторых полей в коде:
