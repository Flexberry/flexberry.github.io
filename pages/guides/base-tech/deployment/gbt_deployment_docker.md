...
### Установка и запуск контейнера Apache: kafnevod/altlinux.p8-apache2 
...
### Проверка работы виртуального сайта в контейнере Apache: kafnevod/altlinux.p8-apache2 
...
### Проверка работы контейнера Mono/.NET-приложений контейнера Mono/.NET-приложений
...
### Проверка работы виртуального сайта в контейнере Mono/.NET-приложений контейнера Mono/.NET-приложений
