...
Несомненным достоинством docker является наличие на настоящий момент сотен официальных образов и до полумиллиона неофициальных публичных образов на портале https://hub.docker.com/. Найдя необходимый образ приложения Вы можете его установить на свой компьютер и на его основе запускать контейнеры приложения не заботясь о несовместимости Linux-дистрибутивов.
...
Создать собственный подобраз, воспользовавшись инструкцией, приведенной на странице https://hub.docker.com/r/nersc/centos-mpi/
и запускать Ваше MPI-приложение в различными параметрами, на различных Linux-дистрибутивах.
