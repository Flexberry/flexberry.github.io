...
> Если Ваш браузер работает через proxy-сервер, опишите тестируемые адреса и домены сервера в поле _не использовать proxy-сервер для_ окна настройки proxy-сервера браузера.
