...
Запуск собственного виртуального Mono/.NET сайта аналогичен запуску [виртуального сайта Apache2-сервера](./gbt_deployment_docker.html#Запуск-собственного-виртуального-сайта-в-рамках-контейнера-apache):
