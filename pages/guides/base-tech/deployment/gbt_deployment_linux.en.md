...
lang: en 
autotranslated: true 
hash: 4f45bce0be3d1cc08c83ff16e39e5901ce7cc2efabc7065a411ccf9a6f66ff8c
---
...
BaseALT P8 [Download](https://www.basealt.ru/products/alt-workstation/) | [REC](https://www.altlinux.org/Write) | [Setting](http://basealt.ru/static/Basealt_Desktop_Установка.pdf) | [License](https://www.basealt.ru/products/alt-workstation/license/) 
...
* [The Linux command "A to Z", an overview with examples](http://edu-cisco.org/docs/lp/Linux-handbook-comands-A-Z-SEDICOMM-University.pdf)
...
* Ubuntu [Apache HTTP Server](http://help.ubuntu.ru/wiki/apache2)
* The distribution of ROSA: [Install Apache, PHP, MySQL ](http://wiki.rosalab.ru/ru/index.php/Ustanovkakh,_PHP,_MySQL)
